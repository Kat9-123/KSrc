...
from pynput.mouse import Controller # Mouse input lib
from datetime import datetime # Date lib
from tkinter import Tk, filedialog # Import TK from tkinter and import Filedialog from tkinter for dir
from os import startfile # Import os lib
